...
export default function ConfirmStatusCategory({
  open,
  handleClose,
  id,
  payload,
  ...
  const updateCategoryStatus = async (id: string, payload: any) => {
    const body = {
      value: payload,
    }
    const fetch = await CategoryService.updateCategoryStatus(id, body);
            ...
            <div className="w-full relative bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0 ">
              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                <h1 className="font-medium text-[16px] text-center">
                  Do you agree to change status category?
                </h1>
                <div className="flex gap-x-4">
                  ...
                  <button
                    ...
                    onClick={() => updateCategoryStatus(id, payload)}
                  >
                    Submit
                  </button>
                </div>
