...
import { FormGroup, FormField, Form, Input, Header, Image, Select, Button, Rating, Label, Icon, Loader } from 'semantic-ui-react'
                    ...
                    <div className='w-full flex flex-col justify-center items-start gap-2'>
                        ...
                        <div className='flex justify-start items-start gap-8'>
                            <div className='relative'>
                                <Image src={data?.thumbnail} size='small' className='rounded-lg mb-4' />
                                <div className="flex flex-col items-center justify-center absolute top-0 right-0">
                                    <label htmlFor="thumbnai1" className="cursor-pointer hover:opacity-80 p-0.5 rounded-full font-semibold text-xs">
                            ...
                            <div className='flex flex-col justify-start items-start'>
                                ...
                                <span className=''><strong>119.000</strong> followers</span>
                            </div>
                        </div>
                        <Form className='w-full'>
                            <FormGroup widths='equal'>
                                <FormField>
                                    <label>Name</label>
                                    <Input fluid placeholder='Name' value={data?.name} onChange={(e) => handleUpdateInput('name', e.target.value)} />
                                </FormField>
                                <FormField>
                                    <label>Email</label>
                                    <Input fluid placeholder='Email' value={data?.email} onChange={(e) => handleUpdateInput('email', e.target.value)} />
                                </FormField>
                                <FormField>
                                    <label>Phone</label>
                                    <Input fluid placeholder='Phone' value={data?.phone} onChange={(e) => handleUpdateInput('phone', e.target.value)} />
                                </FormField>
                            </FormGroup>
                        </Form>
                        <Form className='w-full'>
                            <FormGroup widths='equal'>
                                <FormField>
                                    <label>Address</label>
                                    <Input fluid placeholder='Address' value={addressValue} onChange={(e) => setAddressValue(e.target.value)} />
                                </FormField>
                                <FormField>
                        ...
                        <div className='w-full flex justify-end items-center'>
                            <Button primary onClick={handleUpdate} loading={loading ? true : false}>Update</Button>
                        </div>
                    </div>
            }
        </>
