...
import AnalysisReturn from "./analysis-return"
import AnalysisVoucher from "./analysis-voucher"
    ...
    return (
        <div className='w-full flex flex-col'>
            ...
            <div className="w-full grid grid-cols-2 gap-10 mt-8">
                <div>
                    <Header as='h2'>Order Completion Analysis</Header>
                    <div className='w-full grid grid-cols-1'>
                        <div className="flex flex-col gap-4">
                            <div>
                                <Header as='h3' className="!m-0">Return Rate</Header>
                                <div className="font-medium mt-1">Evaluate return rates to understand product issues or customer dissatisfaction.</div>
                            </div>
                            <AnalysisReturn month={7} />
                        </div>
                    </div>
                </div>
                <div>
                    <Header as='h2'>Profit Analysis</Header>
                    <div className='w-full grid grid-cols-1'>
                        <div className="flex flex-col gap-4">
                            <div>
                                <Header as='h3' className="!m-0">Promotional Impact</Header>
                                <div className="font-medium mt-1">Analyze the impact of promotions or discounts on profits.</div>
                            </div>
                            <AnalysisVoucher month={7} />
                        </div>
                    </div>
                </div>
            </div>
