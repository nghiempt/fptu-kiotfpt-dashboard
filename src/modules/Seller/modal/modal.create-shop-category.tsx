...
const ModalCreateShopCategory: React.FC<ModalCreateShopCategoryProps> = ({ open, setOpen, initialData }) => {
    ...
    return (
        ...
        >
            ...
            <ModalContent image className='!relative !flex !flex-row !justify-center !items-start !gap-36'>
